...
public class LoadXmlModelService extends AbstractService {
    ...
    public void execute() throws Exception {
        LoadXmlModelCommand command;
        if (argument == null) {
            command = new LoadXmlModelCommand();
        } else {
            command = new LoadXmlModelCommand(argument.filename);
        }
        command.execute();
    }
