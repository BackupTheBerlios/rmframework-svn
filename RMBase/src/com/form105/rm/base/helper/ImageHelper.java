 ...
 */
package com.form105.rm.base.helper;
...
public class ImageHelper {
    ...
    public ImageHelper() {
        PropertiesContainer properties = (PropertiesContainer) Container.getInstance().getComponentInstance(PropertiesContainer.class);
